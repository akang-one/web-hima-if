...
<head>
    ...
    <!-- Custom styles for this template Adminpage-->
    <link href="<?= base_url('assets/') ?>adminpage/css/sb-admin-2.min.css" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= site_url('admin') ?>">
                ...
                <div class="sidebar-brand-text mx-3">ADMIN<br>HIMA IF</div>
            </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="<?= site_url('user/change_pass') ?>">
