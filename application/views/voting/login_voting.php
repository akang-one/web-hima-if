                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <h1 class="h5 text-gray-900 mb-4"><?= $nama_voting; ?> Periode <?= $periode; ?></h1>
                                    </div>
                                    <hr>
                                    <br>
                                    <br>
                                    ...
                                    <form action="" method="POST" class="user">
                                        <div class="form-group">
                                            <input type="text" name="npm" class="form-control form-control-user" placeholder="Masukan NPM..." required>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <br>
                                    <div class="text-center">
                                        <p class="small">Silahkan masukan NPM untuk memulai Voting</p>
                                    </div>
                                    <div class="text-center">
                                        <p class="small">Voting hanya bisa dilakukan satu kali</p>
                                    </div>
                                    <div>
                                        <a href="<?= base_url('') ?>" class="btn btn-warning btn-block">
                                            Kembali
                                        </a>
                                    </div>
                                </div>
